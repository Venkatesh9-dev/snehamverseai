  ...
  return (
    <main className="bg-zinc-950 text-zinc-50 min-h-screen selection:bg-cyan-500/30 font-sans pb-32">
      ...
      <style>{`
        ...
        .workshop-btn:hover { background-color: #e4e4e7; }
        .workshop-btn-full { width: 100%; }
      `}</style>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-1/3 lg:sticky lg:top-32 space-y-8">
            ...
            <p className="text-zinc-400 text-lg leading-relaxed font-light">
              A comprehensive, responsible, and practical AI education model designed for institutions
              preparing for an AI-driven future.
            </p>

            <div className="hidden lg:block pt-8">
              <a href="/workshops" className="workshop-btn">
                Request a Workshop
              </a>
            </div>
          </div>
          ...
          <div className="lg:w-2/3 space-y-8">
            ...
            <div className="lg:hidden pt-12">
              <a href="/workshops" className="workshop-btn workshop-btn-full">
                Request a Workshop
              </a>
            </div>
